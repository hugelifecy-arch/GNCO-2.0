...
const steps = [
  ...
  {
    title: 'Model & Compare',
    body: 'GNCO scores all 14 jurisdictions and recommends your top 3 structures. Compare tax efficiency, formation cost, LP familiarity, and timeline side by side. Model the tax impact for each LP individually.',
    visual: (
      <div className="rounded-lg border border-bg-border bg-bg-elevated p-5">
