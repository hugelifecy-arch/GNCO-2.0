...
export const JURISDICTION_METADATA: Record<string, JurisdictionMetadata> = {
  ...
  difc: createMetadata({
    status: 'ACTIVE',
    last_verified_date: VERIFIED_DATE,
    vehicles: 'DIFC LP, Exempt Fund, QIF, and Public Fund structures under DFSA oversight.',
    regulator: { name: 'Dubai Financial Services Authority (DFSA)', url: 'https://www.dfsa.ae/' },
    timelines: 'Typical setup ranges from 1-24 weeks depending on manager licensing and fund category complexity.',
    tax_headline: 'DIFC offers a 0% tax environment at fund level with UAE federal tax and VAT considerations for related activities.',
    key_compliance: 'DFSA authorization/registration, AML module adherence, annual audit, and FATCA/CRS reporting obligations.',
    service_providers: 'DFSA-authorized managers, DIFC corporate service providers, and regional Big Four audit teams.',
    official_links: {
      regulator: 'https://www.dfsa.ae/Regulated-Entities/Funds',
      registry: 'https://www.difc.ae/business/setting-up/registrar-of-companies/',
      tax_authority: 'https://tax.gov.ae/',
    },
    citations: [
      { title: 'DFSA - Fund Regime', url: 'https://www.dfsa.ae/Regulated-Entities/Funds' },
    ],
    confidence: 'HIGH',
  }),
}
